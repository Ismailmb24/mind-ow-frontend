...
export default function SignupForm() {
    ...
    return (
        <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-24">
          <Toaster className="bg-white" position="top-center" richColors />
              ...
              <div className="space-y-6">
                ...
                <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="group relative flex gap-5 w-full justify-center rounded-lg bg-[#2d4a9e] px-4 py-5 text-sm font-semibold text-white transition-all hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2"
                  >
                    {isLoading ? 
                    (<Spinner className="mx-2 size-5 animate-spin" />)
                    :
                    (<>
                      <span>Sign Up</span>
                      <svg
